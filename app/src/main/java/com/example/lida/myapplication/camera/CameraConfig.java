...
import com.example.lida.myapplication.camera.config.CameraResolution;
import com.example.lida.myapplication.camera.config.CameraImageFormat;
...
public class CameraConfig {
    ...
    public Builder getBuilder(View.OnClickListener context) {
